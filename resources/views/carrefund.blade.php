<x-layout :title="'ကားခမှားပေါင်း၍ ပြန်နှုတ်သည့်စာရင်း'.$monthsaryinid">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table p-0">
                            <table class="table align-items-center mb-0" id="posts-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="my-0 py-0">
                                        ...
                                        <td class="noprint my-0 py-0"><a href=""class="btn btn-outline-primary my-0 py-0" data-bs-toggle="modal" data-bs-target="#carrefundEdit{{$d->id}}">edit</a></td>
                                    </tr>
                                    <x-carrefundedit :d="$d" monthsaryinid="{{$monthsaryinid}}" />
                                    @endforeach
                                    <tr class="my-0 py-0">
                                    ...
                                    <div class="text-center">
                                        <h5> ကားခမှားပေါင်း၍ ပြန်နှုတ်သည့်စာရင်း</h5>
                                    </div>
                                </tbody>
                            </table>
                            <div class="text-end container noprint">
                                ...
                                <x-carrefund monthsaryinid="{{$monthsaryinid}}"/>
                            </div>
                        </div>
                    </div>
                </div>
