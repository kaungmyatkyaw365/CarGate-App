<x-layout :title="'လားရှိုးမှလောက်ကိုင်သို့ ပစ္စည်းဖိုး ထပ်ဆောင်းပေးရသည့်စာရင်း'.$monthsaryinid">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table p-0">
                            <table class="table align-items-center mb-0" id="posts-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="my-0 py-0">
                                        ...
                                        <td class="noprint my-0 py-0"><a href=""class="btn btn-outline-primary my-0 py-0" data-bs-toggle="modal" data-bs-target="#additionalEdit{{$d->id}}">edit</a></td>
                                    </tr>
                            ...
                            <div class="text-end container noprint">
                                ...
                                <x-additional monthsaryinid="{{$monthsaryinid}}" />
                            </div>
                        </div>
                    </div>
                </div>
