<x-layout :title="'စိုက်ငွေ ပေးရန်စာရင်း'.$monthsaryinid">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class=" p-0">
                            <table class="table align-items-center mb-0" id="posts-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="my-0 py-0">
                                        ...
                                        <td class="noprint my-0 py-0"><a href=""class="btn btn-outline-primary my-0 py-0" data-bs-toggle="modal" data-bs-target="#tkModelEdit{{$d->id}}">edit</a></td>
                                    </tr>
                                    <x-tkedit :d="$d" />
                                    @endforeach
                                    <tr class="my-0 py-0">
                                    ...
                                    <div class="text-center">
                                        <h5 contenteditable="true">စိုက်ငွေ ပေးရန်စာရင်း</h5>
                                    </div>
                                </tbody>
                            </table>
                            <div class="text-end container noprint">
                                ...
                                <x-tksite-model monthsaryinid="{{$monthsaryinid}}" />
                            </div>
                        </div>
                    </div>
                </div>
