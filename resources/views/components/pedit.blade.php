<!-- Modal -->
<div class="modal fade" aria-hidden="true" id="pModelEdit{{$d->id}}" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form role="form" action="{{route('psite.destroy',$d->id)}}" method="POST">
                    @csrf
                    @method('delete')
                    <button type="submit" class="btn btn-outline-danger">Delete</button>
                </form>
            </div>
            <form role="form" action="{{route('psite.update',$d->id)}}" method="POST">
                @csrf
                @method('put')
                <div class="modal-body">
                    ...
                    <div class="d-flex ">
                        ...
                        <div class="mb-3 d-flex">
                            <input type="number" required class="form-control" value="{{$d->item}}" name="item">
                        </div>
                    </div>
                    <div class="d-flex ">
