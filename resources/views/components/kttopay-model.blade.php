<!-- Modal -->
<div class="modal fade" aria-hidden="true" id="ktModelPayAdd" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">ကျိုင်းတုံဂိတ်အား ပေးရန်</h1>
            ...
            <form role="form" action="{{route('saryin')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="to_get" value="0">
                </div>
