<!-- Modal -->
<div class="modal fade" aria-hidden="true" id="tksiteAdd" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">
                    ကျိုင်းတုံဂိတ်အား စိုက်ငွေပေးရန် စာရင်း
                </h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form role="form" action="{{route('tksite.store')}}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="d-flex ">
                        <label style="font-size: 15px;" class="col-md-3">ပေးရန်ငွေ</label>
                        <div class="mb-3 d-flex">
