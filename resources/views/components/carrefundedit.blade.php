<!-- Modal -->
<div class="modal fade" aria-hidden="true" id="carrefundEdit{{$d->id}}" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form role="form" action="addes/{{$d->id}}" method="POST">
                    @csrf
                    @method('delete')
